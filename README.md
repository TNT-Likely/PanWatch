...
![智盘 Alpha · AlphaMind · TradingAgents 深度分析演示](docs/screenshots/tradingagents-demo.gif)
...
> 💡 如果智盘 Alpha 对你有帮助，点右上角 ⭐ **Star** 支持一下 —— 这是对开源项目最好的鼓励，也能让更多人发现它。
