...
_SSE_EVENT_NAMES = {
    ...
    TaskEventType.TOOL_RESEARCH_STARTED: "tool_research_started",
    TaskEventType.TOOL_CANDIDATES_SCORED: "tool_candidates_scored",
    TaskEventType.TOOL_RESEARCH_COMPLETED: "tool_research_completed",
    TaskEventType.TOOL_RESEARCH_FALLBACK: "tool_research_fallback",
