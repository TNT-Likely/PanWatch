...
class TaskEventType(StrEnum):
    ...
    TOOL_RESEARCH_STARTED = "tool_research_started"
    TOOL_CANDIDATES_SCORED = "tool_candidates_scored"
    TOOL_RESEARCH_COMPLETED = "tool_research_completed"
    TOOL_RESEARCH_FALLBACK = "tool_research_fallback"
