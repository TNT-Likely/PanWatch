  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col border-r border-border/50 bg-card/40 px-3 py-4 backdrop-blur-sm">
      <button
        type="button"
        onClick={onCreate}
        className="flex h-10 items-center justify-center gap-2 rounded-xl border border-primary/25 bg-primary/10 px-3 text-body font-medium text-primary transition-colors hover:bg-primary/15"
      >
        <Plus className="h-4 w-4" />
        新研究
      </button>
      <div className="mt-6 flex items-center gap-2 px-2 text-caption font-medium text-muted-foreground">
