    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {!initialSummary && loading ? (
          ...
          <div className="text-body-sm text-destructive">{error}</div>
        ) : !effectiveSummary ? (
          <div className="text-body-sm text-muted-foreground">暂无数据</div>
        ) : (
          <div className="space-y-3">
            {suggestion && (
              <div className="p-3 rounded-lg bg-accent/20 border border-border/30">
                ...
                <div className="mt-2 text-body-sm text-foreground font-medium">
                  {suggestion.signal}
                </div>
                ...
                <HoverPopover
                  ...
                  content={
                    <div className="space-y-2">
                      ...
                      <div className="text-mini text-muted-foreground">当前：{effectiveSummary.trend}</div>
                ...
                <HoverPopover
                  ...
                  content={
                    <div className="space-y-2">
                      ...
                      <div className="text-mini text-muted-foreground">当前：{effectiveSummary.kline_pattern}</div>
                      <div className="text-mini text-muted-foreground">
